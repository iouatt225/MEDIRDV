...
export default function AdminDashboardPage() {
  ...
  return (
    <div className="space-y-6">
      <section className="relative overflow-hidden rounded-[36px] border border-[#0b1420]/10 bg-[#0b1420] px-6 py-7 text-white shadow-[0_24px_70px_rgba(11,20,32,0.22)] sm:px-8 lg:px-10 lg:py-9">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,_rgba(0,168,188,0.28),_transparent_28%),radial-gradient(circle_at_bottom_left,_rgba(255,255,255,0.1),_transparent_34%)]" />
        <div className="relative flex flex-col gap-6 xl:flex-row xl:items-end xl:justify-between">
          <div className="max-w-3xl space-y-4">
            <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/6 px-4 py-2 text-[11px] font-semibold uppercase tracking-[0.35em] text-white/70">
              <TrendingUp className="h-3.5 w-3.5 text-[#7de4ef]" />
            ...
            <p className="max-w-2xl text-sm leading-7 text-white/70 sm:text-base">
              ...
              les roles et la sante de la plateforme sans changer la palette MediRDV.
            </p>

            <div className="flex flex-wrap gap-3">
              <Link
                href="/admin/users"
                className="inline-flex items-center gap-2 rounded-full bg-white px-5 py-3 text-sm font-semibold text-[#0b1420] transition hover:-translate-y-0.5"
              >
                Gerer les comptes
              ...
              <Link
                href="/admin/analytics"
                className="inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/6 px-5 py-3 text-sm font-semibold text-white transition hover:bg-white/12"
              >
                Voir les analytics
              </Link>
            </div>
          ...
          <div className="grid grid-cols-2 gap-3 sm:grid-cols-4 xl:min-w-[460px]">
            {overviewCards.map((metric) => {
              ...
              return (
                <div key={metric.key} className="rounded-[24px] border border-white/10 bg-white/7 p-4">
                  <div className="flex items-start justify-between gap-3">
                    ...
                    <Icon className="h-5 w-5 text-[#7de4ef]" />
                  </div>
                </div>
              );
            })}
